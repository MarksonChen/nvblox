if(USE_SYSTEM_GLOG)
  ...
  # Disable printing of stack trace for now. Note(dtingdahl): Might have
  # something to do with unwind library not found.
  ...
  # Disable gflags to avoid system libs being picked up by find_package() inside
  # glog's CMakeLists.txt. TODO(dtingdahl): From cmake>=3.24 it is possible to
  # use the OVERRIDE_FIND_PACKAGE option to FetchContent_Declare() which make
  # find_package() point use the sources specified by FetchContent instead.
